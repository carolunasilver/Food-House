...
const Categories = () => {
    return (
        <div class="jumbotron jumbotron-fluid categories">
            <h1 style={{fontWeight: "bold", color: "orangered"}}>Different Categories</h1>
            <h3>Beef</h3>						
            ...
            <img src="https://www.themealdb.com/images/separator.jpg" width='89%'/>
            <h3>Chicken</h3>	
            ...
            <p>Lamb, hogget, and mutton are the meat of domestic sheep (species Ovis aries) at different ages. A sheep in its first year is called a lamb, and its meat is also called lamb. The meat of a juvenile sheep older than one year is hogget; outside the USA this is also a term for the living animal. The meat of an adult sheep is mutton, a term only used for the meat, not the living animals. The term mutton is almost always used to refer to goat meat in the Indian subcontinent.</p>
            <img src="https://www.themealdb.com/images/separator.jpg" width='89%'/>
            <h3>Goat</h3>				
            <img src= 'https://www.themealdb.com/images/category/goat.png'/>
            <p>The domestic goat or simply goat (Capra aegagrus hircus) is a subspecies of C. aegagrus domesticated from the wild goat of Southwest Asia and Eastern Europe. The goat is a member of the animal family Bovidae and the subfamily Caprinae, meaning it is closely related to the sheep. There are over 300 distinct breeds of goat. Goats are one of the oldest domesticated species of animal, and have been used for milk, meat, fur and skins across much of the world. Milk from goats is often turned into goat cheese.</p>
            <img src="https://www.themealdb.com/images/separator.jpg" width='89%'/>
            <h3>Seafood</h3>	
            ...
            <p>Pasta is a staple food of traditional Italian cuisine, with the first reference dating to 1154 in Sicily. Also commonly used to refer to the variety of pasta dishes, pasta is typically a noodle made from an unleavened dough of a durum wheat flour mixed with water or eggs and formed into sheets or various shapes, then cooked by boiling or baking. As an alternative for those wanting a different taste, or who need to avoid products containing gluten, some pastas can be made using rice flour in place of wheat. Pastas may be divided into two broad categories, dried (pasta secca) and fresh (pasta fresca).</p>
            <img src="https://www.themealdb.com/images/separator.jpg" width='89%'/>
            <h3>Vegetarian</h3>				
            ...
            <p>Breakfast is the first meal of a day. The word in English refers to breaking the fasting period of the previous night. There is a strong likelihood for one or more "typical", or "traditional", breakfast menus to exist in most places, but their composition varies widely from place to place, and has varied over time, so that globally a very wide range of preparations and ingredients are now associated with breakfast.</p>
            <img src="https://www.themealdb.com/images/separator.jpg" width='89%'/>
            <h3>Dessert</h3>				
            ...
            <p style={{textAlign: "center"}}>General foods that don't fit into another category.</p>
        </div>
