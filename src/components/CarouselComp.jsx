        ...
        return (
            <Carousel>
                <Carousel.Item>
                    ...
                    <p style={{textAlign: "center", color: "black", fontSize: "22px", fontWeight: "bold"}}>Click on Random Recipes and surprise your guests!</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    ...
                    <p style={{textAlign: "center", fontWeight: "bold"}}>Use the search bar to type a main ingredient and find easy recipes...</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    ...
                    <p style={{textAlign: "center", fontWeight: "bold"}}>Watch the video under the Recipe.</p>
                    </Carousel.Caption>
                </Carousel.Item>
            </Carousel>
         );
